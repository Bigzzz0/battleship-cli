...
*   **บิ๊ก (Planner / Coder):** วางแผนโปรเจกต์, ออกแบบโครงสร้าง, Implement Backend
*   **อาต (Coder / Debugger):** Implement Logic หลัก, Frontend, Debugging
*   **แทน (Debugger / Planner):** ทดสอบระบบ, รีวิวโค้ด, จัดทำเอกสาร
